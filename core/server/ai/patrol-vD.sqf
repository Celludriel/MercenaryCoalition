...
if(isNil("LV_CloseDoors"))then{LV_CloseDoors = compile preprocessFile "core\server\ai\LV_functions\LV_fnc_closeDoors.sqf";};
if(isNil("LV_nearestBuilding"))then{LV_nearestBuilding = compile preprocessFile "core\server\ai\LV_functions\LV_fnc_nearestBuilding.sqf";};
