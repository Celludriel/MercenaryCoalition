...
params ["_location", "_captureRadius", "_buildingType", "_captureTime", "_side", ["_markerType", "mil_objective"], ["_eventScripts", [[],[],[]]]];
...
// spawn server thread
[_captureBuilding, _captureRadius, _captureTime, _eventScripts] execVM (DYNCAP_PATH + "dynServerCaptureMonitor.sqf");
